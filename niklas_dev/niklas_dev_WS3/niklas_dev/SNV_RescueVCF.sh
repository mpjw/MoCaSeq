...
rm $name_rescue_to/results/rescued/$name_rescue_from.$name_rescue_from_method.vcf.gz.tbi
...
rm $name_rescue_to/results/rescued/$name_rescue_to.$name_rescue_to_method.vcf.gz.tbi
...
/home/rad/packages/GetBaseCountsMultiSample-1.2.3/./GetBaseCountsMultiSample \
...
echo "You can ignore this bgzip error"
...
echo "You can ignore this gunzip error"
...
rm $name_rescue_to/results/rescued/$name_rescue_to.$name_rescue_to_method.$name_rescue_from.$name_rescue_from_method.vcf.gz.tbi
rm $name_rescue_to/results/rescued/$name_rescue_to.$name_rescue_to_method.vcf.gz.tbi
...
echo "You can ignore this rm errors"
rm $name_rescue_to/results/rescued/$name_rescue_from.$name_rescue_from_method.txt
rm $name_rescue_to/results/rescued/$name_rescue_to.$name_rescue_to_method.txt
rm $name_rescue_to/results/rescued/$name_rescue_from.$name_rescue_from_method.vcf
rm $name_rescue_to/results/rescued/$name_rescue_to.$name_rescue_to_method.vcf
rm $name_rescue_to/results/rescued/$annotate.ann1.vcf
rm $name_rescue_to/results/rescued/$annotate.ann2.vcf
rm $name_rescue_to/results/rescued/$annotate.ann3.vcf
rm $name_rescue_to/results/rescued/$annotate.ann4.vcf
rm $name_rescue_to/results/rescued/$annotate.ann5.vcf
rm $name_rescue_to/results/rescued/$annotate.ann6.vcf
rm $name_rescue_to/results/rescued/$annotate.ann7.vcf
rm $name_rescue_to/results/rescued/$annotate.annotated.vcf
rm $name_rescue_to/results/rescued/$annotate.annotated.one.vcf
rm $name_rescue_to/results/rescued/$annotate.annotated.vcf.stats
rm $name_rescue_to/results/rescued/$annotate.annotated.vcf.stats.genes.txt
done
