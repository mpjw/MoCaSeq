...
germCNV <- fread("/media/rad/HDD1/hMANEC/combined_results/CNA_dev/filter_regions_annotations/ClinVar_CNVs.txt")
...
custom <- data.table(chr=5, start=180955335, end=180985333)
custom[, class := "Custom"]
