#THIS CODE IS NOW DEPRECATED IN FAVOR OF repository/vcf_annotation/Annotate_Variants_Wrapper.sh
...
bash/opt/MoCaSeq/repository/vcf_annotation/Annotate_Variants_Wrapper.sh 1187-2 Mouse
