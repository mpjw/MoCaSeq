...
# bash /opt/MoCaSeq/niklas_dev/all_RunSclust.sh hPDAC07_LivMet-1 Human /opt/MoCaSeq/config.sh WES "Tumor Normal"
# bash /opt/MoCaSeq/niklas_dev/all_RunSclust.sh hPDAC07_PPT-1 Human /opt/MoCaSeq/config.sh WES "Tumor Normal"
# bash /opt/MoCaSeq/niklas_dev/all_RunSclust.sh hPDAC09_LivMet-1 Human /opt/MoCaSeq/config.sh WES "Tumor Normal"
# bash /opt/MoCaSeq/niklas_dev/all_RunSclust.sh hPDAC09_PPT-1 Human /opt/MoCaSeq/config.sh WES "Tumor Normal"
# bash /opt/MoCaSeq/niklas_dev/all_RunSclust.sh hPDAC10_LivMet-1 Human /opt/MoCaSeq/config.sh WES "Tumor Normal"
# bash /opt/MoCaSeq/niklas_dev/all_RunSclust.sh hPDAC10_PPT-1 Human /opt/MoCaSeq/config.sh WES "Tumor Normal"
# bash /opt/MoCaSeq/niklas_dev/all_RunSclust.sh hPDAC12_LivMet-1 Human /opt/MoCaSeq/config.sh WES "Tumor Normal"
# bash /opt/MoCaSeq/niklas_dev/all_RunSclust.sh hPDAC12_PPT-1 Human /opt/MoCaSeq/config.sh WES "Tumor Normal"
# bash /opt/MoCaSeq/niklas_dev/all_RunSclust.sh hPDAC14_LivMet-1 Human /opt/MoCaSeq/config.sh WES "Tumor Normal"
# bash /opt/MoCaSeq/niklas_dev/all_RunSclust.sh hPDAC14_PPT-1 Human /opt/MoCaSeq/config.sh WES "Tumor Normal"
# bash /opt/MoCaSeq/niklas_dev/all_RunSclust.sh hPDAC17_LivMet-1 Human /opt/MoCaSeq/config.sh WES "Tumor Normal"
# bash /opt/MoCaSeq/niklas_dev/all_RunSclust.sh hPDAC17_PPT-1 Human /opt/MoCaSeq/config.sh WES "Tumor Normal"
